...
import board.repository.CeolistRepository;
...
public class JpaBoardServiceImpl implements JpaBoardService {
	...
	@Autowired
	CeolistRepository ceolistRepository;
	
	@Autowired 
	FileUtils fileUtils;
	
	@Override
	public List<CeoEntity> selecCeoList() throws Exception {
		return ceolistRepository.findAllByOrderByCeoIdxDesc();
	}
	
	@Override
	public void saveCeoEntity(CeoEntity ceoEntity, MultipartHttpServletRequest request) throws Exception {
		ceolistRepository.save(ceoEntity);		
	}
